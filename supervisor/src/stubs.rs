...
---@field pid integer The Supervisor's process id, as `mantle list` shows it; `mantle stop --pid` ends this shell. Not a signal. [docs]({DOCS}capabilities/index.html#renderer-members)
mantle = {}
"#;
