...
//! command is `env LC_ALL=C pkexec pacman -Syu --noconfirm`, run by `controller.rs` through
//! `process::spawn_group_leader_piped`; `pkexec` talks to polkit and triggers the Mantle polkit
