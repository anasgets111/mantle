...
fn temp_name() -> String {
    ...
    format!(".mantle-{}-{}.png.tmp", std::process::id(), NEXT.fetch_add(1, Ordering::Relaxed))
}
...
impl Slot {
    ...
    pub fn write(&self, rgba: &[u8], width: u32, height: u32) -> io::Result<()> {
        ...
        let result = (|| -> io::Result<()> {
            ...
            encoder.add_text_chunk("Software".to_string(), "Mantle".to_string()).map_err(io::Error::other)?;
