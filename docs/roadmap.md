...
| Large lists | Every item up to `limit` is constructed: 0.25 ms at 12 rows, 10.9 ms at 500. Virtualization would need `key` to be mandatory, which cannot be enforced | 0191, 0219 |
