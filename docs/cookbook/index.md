...
| [Workspaces](workspaces.md) | Per-monitor workspace pills for Hyprland and niri, with wheel switching and Hyprland special workspaces | Per-output `child`, keyed `list`, capability actions |
